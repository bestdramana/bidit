...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  .state('app.add_bid', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/add_bid.html",
        controller: 'BidCtrl'
      }
    }
  })
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/bid_list.html",
  ...
  .state('app.show_bid', {
  url: "/show-bid/:bidId/:sourceId",
  cache: false,
  views: {
    'menuContent': {
      templateUrl: "views/app/show_bid.html",
      controller: 'ShowBidCtrl'
    }
  }
})
